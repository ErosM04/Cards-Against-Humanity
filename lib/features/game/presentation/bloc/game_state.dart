...
final class NoCardClicked extends GameState {}

final class OneCardCliked extends GameState {
  final CardAH card;

  OneCardCliked({required this.card});
}

final class TwoCardsCliked extends GameState {
  final CardAH card1;
  final CardAH card2;

  TwoCardsCliked({required this.card1, required this.card2});
}
